...
module interface(
    input wire clk,
    input wire rst,
    input wire [15:0] baud_div_val,
	/* interface with external IO */
    input wire newdata_ext,
    input wire [7:0] din_ext, // extin->interface
    ...
    input wire [7:0] din_from_uart, // UART->interface
    output wire [7:0] dout_to_uart, // interface->UART
    output reg error
    );
